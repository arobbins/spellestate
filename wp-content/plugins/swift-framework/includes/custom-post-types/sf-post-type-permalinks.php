    ...
    if ( ! class_exists( 'sf_post_type_permalinks' ) ) :
        ...
        class sf_post_type_permalinks {
            ...
            public function settings_init() {
                ...
                add_settings_section( 'sf-portfolio-permalink', __( 'Portfolio permalink base', 'swift-framework-plugin' ), array(
                        $this,
                        'portfolio_settings'
                    ), 'permalink' );

                // Add portfolio settings
                add_settings_field( 'portfolio_category_slug', __( 'Portfolio category base', 'swift-framework-plugin' ), array(
                        $this,
                        'portfolio_category_slug_input'
                    ), 'permalink', 'optional' );

                // Add galleries section to the permalinks page
                add_settings_section( 'sf-galleries-permalink', __( 'Galleries permalink base', 'swift-framework-plugin' ), array(
                        $this,
                        'galleries_settings'
                    ), 'permalink' );

                // Add galleries settings
                add_settings_field( 'galleries_category_slug', __( 'Galleries category base', 'swift-framework-plugin' ), array(
                        $this,
                ...
                // Add team settings
                add_settings_field( 'team_category_slug', __( 'Team category base', 'swift-framework-plugin' ), array(
                        $this,
                        'team_category_slug_input'
                    ), 'permalink', 'optional' );

                // Add team section to the permalinks page
                add_settings_section( 'sf-directory-permalink', __( 'Directory permalink base', 'swift-framework-plugin' ), array(
                        $this,
                        'directory_settings'
                    ), 'permalink' );

                // Add team settings
                add_settings_field( 'directory_category_slug', __( 'Directory category base', 'swift-framework-plugin' ), array(
                        $this,
                        'directory_category_slug_input'
                    ), 'permalink', 'optional' );

                // Add team settings
                add_settings_field( 'directory_location_slug', __( 'Directory location base', 'swift-framework-plugin' ), array(
                        $this,
                        'directory_location_slug_input'
                    ), 'permalink', 'optional' );

                // Add faqs section to the permalinks page
                add_settings_section( 'sf-faqs-permalink', __( 'FAQs permalink base', 'swift-framework-plugin' ), array(
                        $this,
                        'faqs_settings'
                    ), 'permalink' );

                // Add team settings
                add_settings_field( 'faqs_category_slug', __( 'FAQ category base', 'swift-framework-plugin' ), array(
                        $this,
            ...
            public function portfolio_category_slug_input() {
                ...
                <input name="portfolio_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'portfolio-category', 'swift-framework-plugin' ) ?>"/>
            <?php
            }
            ...
            public function galleries_category_slug_input() {
                ...
                <input name="galleries_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'galleries-category', 'swift-framework-plugin' ) ?>"/>
            <?php
            }
            ...
            public function team_category_slug_input() {
                ...
                <input name="team_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'team-category', 'swift-framework-plugin' ) ?>"/>
            <?php
            }
            ...
            public function directory_category_slug_input() {
                ...
                <input name="directory_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'directory-category', 'swift-framework-plugin' ) ?>"/>
            <?php
            }
            ...
            public function directory_location_slug_input() {
                ...
                <input name="directory_location_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'directory-location', 'swift-framework-plugin' ) ?>"/>
            <?php
            }
            ...
            public function faqs_category_slug_input() {
                ...
                <input name="faqs_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'faqs-category', 'swift-framework-plugin' ) ?>"/>
            <?php
            }

            public function portfolio_settings() {
                echo wpautop( __( 'These settings control the permalinks used for portfolio items. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'swift-framework-plugin' ) );
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><label><input name="portfolio_permalink" type="radio" value="<?php echo $structures[0]; ?>"
                                          class="sf_port_tog" <?php checked( $structures[0], $portfolio_permalink ); ?> /> <?php _e( 'Default', 'swift-framework-plugin' ); ?>
                            </label></th>
                    ...
                    <tr>
                        <th><label><input name="portfolio_permalink" type="radio" value="<?php echo $structures[1]; ?>"
                                          class="sf_port_tog" <?php checked( $structures[1], $portfolio_permalink ); ?> /> <?php _e( 'Portfolio', 'swift-framework-plugin' ); ?>
                            </label></th>
                    ...
                    <?php if ( $portfolio_page ) : ?>
                        <tr>
                            <th><label><input name="portfolio_permalink" type="radio"
                                              ...
                                              class="sf_port_tog" <?php checked( $structures[2], $portfolio_permalink ); ?> /> <?php _e( 'Portfolio base', 'swift-framework-plugin' ); ?>
                                </label></th>
                            <td><code><?php echo home_url(); ?>/<?php echo $base_slug; ?>/sample-portfolio-item/</code>
                            </td>
                        </tr>
                        <!--<tr>
							<th><label><input name="portfolio_permalink" type="radio" value="<?php echo $structures[3]; ?>" class="sftog" <?php checked( $structures[3], $portfolio_permalink ); ?> /> <?php _e( 'Portfolio base with category', 'swift-framework-plugin' ); ?></label></th>
            ...
            public function galleries_settings() {
                echo wpautop( __( 'These settings control the permalinks used for galleries. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'swift-framework-plugin' ) );
                ...
                $base_slug      = __( 'galleries', 'swift-framework-plugin' );
                $galleries_base = __( 'galleries', 'swift-framework-plugin' );
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><label><input name="galleries_permalink" type="radio" value="<?php echo $structures[0]; ?>"
                                          class="sf_gal_tog" <?php checked( $structures[0], $galleries_permalink ); ?> /> <?php _e( 'Default', 'swift-framework-plugin' ); ?>
                            </label></th>
                    ...
                    <tr>
                        <th><label><input name="galleries_permalink" type="radio" value="<?php echo $structures[1]; ?>"
                                          class="sf_gal_tog" <?php checked( $structures[1], $galleries_permalink ); ?> /> <?php _e( 'Galleries', 'swift-framework-plugin' ); ?>
                            </label></th>
            ...
            public function directory_settings() {
                echo wpautop( __( 'These settings control the permalinks used for directory items. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'swift-framework-plugin' ) );
                ...
                $base_slug      = __( 'directory', 'swift-framework-plugin' );
                $directory_base = __( 'directory', 'swift-framework-plugin' );
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><label><input name="directory_permalink" type="radio" value="<?php echo $structures[0]; ?>"
                                          class="sf_directory_tog" <?php checked( $structures[0], $directory_permalink ); ?> /> <?php _e( 'Default', 'swift-framework-plugin' ); ?>
                            </label></th>
                    ...
                    <tr>
                        <th><label><input name="directory_permalink" type="radio" value="<?php echo $structures[1]; ?>"
                                          class="sf_directory_tog" <?php checked( $structures[1], $directory_permalink ); ?> /> <?php _e( 'Directory', 'swift-framework-plugin' ); ?>
                            </label></th>
            ...
            public function faqs_settings() {
                echo wpautop( __( 'These settings control the permalinks used for FAQs. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'swift-framework-plugin' ) );
                ...
                // Set base slug & directory base
                $base_slug      = __( 'faqs', 'swift-framework-plugin' );
                $faqs_base = __( 'faqs', 'swift-framework-plugin' );
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><label><input name="faqs_permalink" type="radio" value="<?php echo $structures[0]; ?>"
                                          class="sf_faqs_tog" <?php checked( $structures[0], $faqs_permalink ); ?> /> <?php _e( 'Default', 'swift-framework-plugin' ); ?>
                            </label></th>
                    ...
                    <tr>
                        <th><label><input name="faqs_permalink" type="radio" value="<?php echo $structures[1]; ?>"
                                          class="sf_faqs_tog" <?php checked( $structures[1], $faqs_permalink ); ?> /> <?php _e( 'FAQs', 'swift-framework-plugin' ); ?>
                            </label></th>
