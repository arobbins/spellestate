    ...
    SPBMap::map( 'spb_raw_html', array(
        ...
        "params"        => array(
            array(
                ...
                "holder"      => "div",
                "class"       => "",
                "heading"     => __( "Raw HTML", 'swift-framework-plugin' ),
                "param_name"  => "content",
                "value"       => base64_encode( "<p>This is a raw html block.<br/>Click the edit button to change this html.</p>" ),
                "description" => __( "Enter your HTML content.", 'swift-framework-plugin' )
            ),
        )
    ) );
    ...
    SPBMap::map( 'spb_raw_js', array(
        ...
        "params"        => array(
            array(
                ...
                "holder"      => "div",
                "class"       => "",
                "heading"     => __( "Raw js", 'swift-framework-plugin' ),
                "param_name"  => "content",
                "value"       => base64_encode( "alert('Enter your js here.');" ),
                "description" => __( "Enter your JavaScript or jQuery code here.", 'swift-framework-plugin' )
            ),
        )
    ) );