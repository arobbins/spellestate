    ...
    */
    ...
    class SwiftPageBuilderShortcode_spb_counter extends SwiftPageBuilderShortcode {
        ...
        protected function content( $atts, $content = null ) {
            ...
            $output .= "\n\t\t\t" . do_shortcode( '[sf_count from="' . $from . '" to="' . $to . '" speed="' . $speed . '" refresh="' . $refresh . '" textstyle="' . $textstyle . '" subject="' . $subject . '" color="' . $textcolor . '" prefix="' . $prefix . '" suffix="' . $suffix . '" commas="' . $commas . '"]' );
            $output .= "\n\t\t" . '</div>';
