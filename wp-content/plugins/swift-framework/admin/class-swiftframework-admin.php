	...
	public function swift_framework_about_content() {
	  ?>
		...
		<div class="about-content">
			...
			<h3>Latest Update (v2.2.61)</h3>
			<p></p>
			<ul>
				<li>FRONTEND: Fix for fade transition stalling progress on Swift Slider</li>
				<li>BACKEND: Re-added missing Campaign element</li>
			</ul>
			<div class="divide"></div>
			<h3>Previous Update (v2.2.5)</h3>
			<p></p>
			<ul>
