...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.0.0', __( 'WooCommerce Customer/Order CSV Import', 'woocommerce-customer-order-csv-import' ), __FILE__, 'init_woocommerce_customer_order_csv_import', array( 'minimum_wc_version' => '2.2', 'backwards_compatible' => '4.0.0' ) );
 ...
 */
$GLOBALS['wc_customer_csv_import'] = wc_customer_csv_import();
