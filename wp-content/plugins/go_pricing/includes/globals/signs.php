...
$go_pricing['sign_types'] = array ( 
	...
	array(
		'group_name' => __( 'Ribbons', 'go_pricing_textdomain' ),
		'group_data' => array(		
			array( 
	...
	array(
		'group_name' => __( 'Badges', 'go_pricing_textdomain' ),
		'group_data' => array(		
			array( 
	...
	array(
		'group_name' => __( 'Tags', 'go_pricing_textdomain' ),
		'group_data' => array(		
			array( 
	...
	array(
		'group_name' => __( 'Objects', 'go_pricing_textdomain' ),
		'group_data' => array(		
			array( 
...
$go_pricing['signs']['clean-ribbon'] = array (						
	...
	array(
		'group_name' => __( 'Grey', 'go_pricing_textdomain' ),
		'group_data' => array(
			array(
				'name' => '50% (' . sprintf( __( '%s side', 'go_pricing_textdomain' ), 'left' ) . ')',
				'value' => 'left-grey-50', 
