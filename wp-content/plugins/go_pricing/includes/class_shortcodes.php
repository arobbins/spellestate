...
class GW_GoPricing_Shortcodes {
	...
	public function pricing_table_sc( $atts, $content = null ) {
		...
		if ( empty( $pricing_table ) ) return '<p>' . sprintf( __( 'Pricing table with an Table ID / Post ID of "%s" is not defined.', 'go_pricing_textdomain' ), !empty( $id ) ? $id : $postid ) . '</p>';
		
		if ( empty( $pricing_table['col-data'] ) && $preview  == 'true' ) return '<div id="go-pricing-forbidden"><i class="fa fa-exclamation-triangle fa-2x"></i>'. __( 'There is nothing to see here, yet. Please, first create columns!', 'go_pricing_textdomain' ) . '</div>';		
		...
		$main_head_html .= sprintf( 
			'<div%1$s data-id="%2$d" data-colnum="%3$d" data-equalize="%4$s"%5$s>', 
			...
			!empty( $pricing_table['responsivity']['enabled'] ) && !empty( $pricing_table['responsivity']['views'] ) ? ' data-views="' . esc_attr( json_encode( $pricing_table['responsivity']['views'] ) ) . '"' : 'rr'
		);
		...
		foreach ( (array)$pricing_table['col-data'] as $col_index => $col_data ) {
			...
			if ( !empty( $pricing_table['style'] ) && $pricing_table['style'] == 'clean' && !empty( $col_data['main-color'] ) ) {
				...
				switch( $column_style ) {
					...
					case 'clean-style1' : 
						...
						.gw-go-col-wrap-<?php echo $col_index; ?>.gw-go-hover .gw-go-header-top { <?php printf( 'background-color:%s;', $col_data['main-color'] ); ?> }
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-price-wrap span,
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coinf div,
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coinb div { <?php printf( 'color:%s;', $col_data['main-color'] ); ?> }						
						</style>						
						<?php
					...
					case 'clean-style2' : 
						...
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-footer-row .gw-go-btn { <?php printf( 'background-color:%s;', $col_data['main-color'] ); ?> }
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coinf div,
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coinb div { <?php printf( 'color:%s;', $col_data['main-color'] ); ?> }											
						</style>						
						<?php
					...
					case 'clean-style3' : 
						...
						<style>
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-header,
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-btn { <?php printf( 'background-color:%s;', $col_data['main-color'] ); ?> }
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coinf div,
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coinb div { <?php printf( 'color:%s;', $col_data['main-color'] ); ?> }
						</style>						
						<?php
					...
					case 'clean-style4' : 
						...
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-body li { <?php printf( 'color:%s;', $col_data['main-color'] ); ?> }
						</style>						
						<?php
						$custom_inline_styles[] = ob_get_clean();
						break;
					...
					case 'clean-style6' : 
						...
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coin-wrap:before,											
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coinf div,
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coinb div,
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-btn {  <?php printf( 'background-color:%s;', $col_data['main-color'] ); ?> }						
						...
						.gw-go-col-wrap-<?php echo $col_index; ?>.gw-go-hover .gw-go-coinb div  { <?php printf( 'color:%s;', $col_data['main-color'] ); ?> }
						.gw-go-col-wrap-<?php echo $col_index; ?>.gw-go-hover .gw-go-btn { <?php printf( 'color:%s !important;', $col_data['main-color'] ); ?> }								
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coinf,
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coinb	{ <?php printf( 'border:solid 2px %s !important;', $col_data['main-color'] ); ?> }
						</style>
						<?php
						$custom_inline_styles[] = ob_get_clean();
						break;
					...
					case 'clean-style9' : 
						...
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-col.gw-go-clean-style9 .gw-go-body li .gw-go-body-cell:before {  <?php printf( 'background-color:%s;', $col_data['main-color'] ); ?> }
						...
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-col.gw-go-clean-style9 .gw-go-body li { <?php printf( 'color:%s;', $col_data['main-color'] ); ?> }
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-col.gw-go-clean-style9 .gw-go-btn {  <?php printf( 'color:%s !important;', $col_data['main-color'] ); ?> }
						</style>
						<?php
						$custom_inline_styles[] = ob_get_clean();
						break;
					...
					case 'clean-style10' : 
						...
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-col.gw-go-clean-style10 .gw-go-coinb { <?php printf( 'color:%s;', $col_data['main-color'] ); ?> }
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-col.gw-go-clean-style10 .gw-go-btn { <?php printf( 'background-color:%s;', $col_data['main-color'] ); ?> }	
						</style>
						<?php
						$custom_inline_styles[] = ob_get_clean();
						break;
					...
					case 'clean-style12' :				 
						...
						?>
						<style>
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-col.gw-go-clean-style12 .gw-go-header h3 { <?php printf( 'color:%s;', $col_data['main-color'] ); ?> }			
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-col.gw-go-clean-style12 .gw-go-btn { <?php printf( 'background-color:%s;', $col_data['main-color'] ); ?> }
						</style>
						<?php
						$custom_inline_styles[] = ob_get_clean();
						break;
					...
					case 'clean-style13' : 
						...
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-btn {  <?php printf( 'background-color:%s;', $col_data['main-color'] ); ?> }
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-header,
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-header h1 { <?php printf( 'color:%s;', $col_data['main-color'] ); ?> }
						.gw-go-col-wrap-<?php echo $col_index; ?>.gw-go-hover .gw-go-btn { <?php printf( 'color:%s !important;', $col_data['main-color'] ); ?> }			
						</style>
						<?php
						$custom_inline_styles[] = ob_get_clean();
					...
					case 'clean-style14' : 
						...
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coinf div, 
						.gw-go-col-wrap-<?php echo $col_index; ?> .gw-go-coinb div { <?php printf( 'color:%s;', $col_data['main-color'] ); ?> }
						.gw-go-col-wrap-<?php echo $col_index; ?>.gw-go-hover .gw-go-btn { <?php printf( 'background-color:%s;', $col_data['main-color'] ); ?> }		
						</style>
						<?php
						$custom_inline_styles[] = ob_get_clean();
						break;
			...
			if ( !empty( $column_style_data['type'] ) ) {
				...
				if ( $column_style_data['type'] != 'html' && $column_style_data['type'] != 'chtml' ) {
					...
					if ( !empty( $col_data['title']['title']['font-family'] ) ) {
					...
					if ( !empty( $col_data['title']['subtitle']['font-family'] ) ) {
						foreach( (array)$go_pricing['fonts'] as $fonts ) {
					...
					if ( $column_style_data['type'] != 'team' && $column_style_data['type'] != 'cteam' ) {
						...
						if ( !empty( $col_data['price']['price-style']['font-family'] ) ) {
							foreach( (array)$go_pricing['fonts'] as $fonts ) {
						...
						if ( !empty( $col_data['price']['payment']['font-family'] ) ) {
							foreach( (array)$go_pricing['fonts'] as $fonts ) {
			...
			if ( !empty( $col_data['col-highlight'] ) ) $col_wrap_classes[] = 'gw-go-hover';
			if ( !empty( $col_data['col-highlight'] ) ) $col_wrap_atts[] = array( 'data-current', true );	
			if ( !empty( $col_data['col-disable-enlarge'] ) ) $col_wrap_classes[] = 'gw-go-disable-enlarge';
			if ( !empty( $col_data['col-disable-hover'] ) ) $col_wrap_classes[] = 'gw-go-disable-hover';
			...
			$col_wrap_header_html = sprintf( '<div%1$s%2$s>', 
			...
			$col_header_html = sprintf( 
				'<div%s><div class="gw-go-col-inner">', 
			...
			if ( !empty( $col_data['decoration']['col-sign'] ) && !empty( $col_data['decoration']['col-sign-type'] ) ) {			
				...
				// Build classes & styles
				if ( $col_data['decoration']['col-sign-type'] == 'custom-img' ) {
			...
			if ( !empty( $column_style_data['type'] ) ) {
				...
				if ( !empty( $pricing_table['style'] ) && $pricing_table['style'] == 'clean' ) {
					...
					if ( !empty( $col_data['header']['style'] ) && $col_data['header']['style']['type'] == 'standard' ) {
				...
				$price_format = !empty( $general_settings['currency'][0]['position'] ) && $general_settings['currency'][0]['position'] == 'left' ? '<span data-id="price"><span data-id="currency">%1$s</span><span data-id="amount">%2$s</span></span>' : '<span data-id="price"><span data-id="amount">%2$s</span><span data-id="currency">%1$s</span></span>';
			...
			foreach ( (array)$pricing_table['col-data'][$col_index]['body-row'] as $body_row_index => $body_row_data ) {
				...
				//print_r( $body_row_data[$body_row_data['type']]['tooltip']);
				...
				// Build html	
				//$tooltip_html = $body_row_data[$body_row_data['type']]['tooltip']['content'];
				...
				if ( !empty( $body_row_data['type'] ) ) {
					...
					if ( $body_row_data['type'] == 'html' ) {
						...
						if ( !empty( $body_row_data['html']['font-family'] ) ) {
							foreach( (array)$go_pricing['fonts'] as $fonts ) {
					...
					if ( $body_row_data['type'] == 'button' ) {
						...
						if ( !empty( $body_row_data['button']['font-family'] ) ) {
							foreach( (array)$go_pricing['fonts'] as $fonts ) {
					...
					switch( $body_row_data['type'] ) {
						...
						case 'button' : 
							...
							// Filter classes & atts
							$button_classes = apply_filters( 'go_pricing_front_body_button_classes', 
								$button_classes, 
								array(
									'pricing_table' => $pricing_table,
									'col_index' => $col_index,
			...
			foreach ( (array)$pricing_table['col-data'][$col_index]['footer-row'] as $footer_row_index => $footer_row_data ) {
				...
				if ( !empty( $footer_row_data['type'] ) ) {
					...
					if ( $footer_row_data['type'] == 'html' ) {
						...
						if ( !empty( $footer_row_data['html']['font-family'] ) ) {
							foreach( (array)$go_pricing['fonts'] as $fonts ) {
					...
					if ( $footer_row_data['type'] == 'button' ) {
						...
						if ( !empty( $footer_row_data['button']['font-family'] ) ) {
							foreach( (array)$go_pricing['fonts'] as $fonts ) {
					...
					switch( $footer_row_data['type'] ) {
						...
						case 'button' : 
							...
							// Filter classes & atts
							$button_classes = apply_filters( 'go_pricing_front_footer_button_classes', 
								$button_classes, 
								array(
									'pricing_table' => $pricing_table,
									'col_index' => $col_index,
		...
		$custom_inline_styles[] = '.gw-go { visibility:visible; }';
