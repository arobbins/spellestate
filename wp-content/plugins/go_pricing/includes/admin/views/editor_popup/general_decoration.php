...
<div class="gwa-section"><span><i class="fa fa-cog"></i></span><?php _e( 'Shadow Settings', 'go_pricing_textdomain' ); ?></div>
...
<div class="gwa-section"><span><i class="fa fa-cog"></i></span><?php _e( 'Sign Settings', 'go_pricing_textdomain' ); ?></div>	
<table class="gwa-table">
	<tr>
	...
	<tr data-parent-id="col-sign-type" data-parent-value="custom-img"<?php echo ( empty($postdata['col-sign-type'] ) ||$postdata['col-sign-type'] != 'custom-img' ? ' style="display:none;"' : '' ); ?>>
		...
		<td>
			<div class="gwa-img-upload">
				...
				<div class="gwa-input-btn"<?php echo ( !empty( $postdata['col-sign']['custom-img']['data'] ) ? 'style="display:none;"': '' ); ?>><input type="text" name="col-sign[custom-img][data]" value="<?php echo ( !empty( $postdata['col-sign']['custom-img']['data'] ) ?  esc_attr( $postdata['col-sign']['custom-img']['data'] ) : '' ); ?>"><a href="#" title="<?php esc_attr_e( 'Add', 'go_pricing_textdomain' ); ?>" data-action="img-upload"><i class="fa fa-plus-circle"></i></a></div>
			</div>															
		</td>
	...
	<tr data-parent-id="col-sign-type" data-parent-value="*"<?php echo ( empty($postdata['col-sign-type'] ) ? ' style="display:none;"' : '' ); ?>>
		...
		<td>
			<select name="col-sign-align">
				<option value="left"<?php echo isset($postdata['col-sign-align'] ) && $postdata['col-sign-align'] == 'left' ? ' selected="selected"' : ''; ?>><?php _e( 'Align Left', 'go_pricing_textdomain' ); ?></option>
				<option value="right"<?php echo isset($postdata['col-sign-align'] ) && $postdata['col-sign-align'] == 'right' ? ' selected="selected"' : ''; ?>><?php _e( 'Align Right', 'go_pricing_textdomain' ); ?></option>
			</select>							
		</td>
	...
	<tr data-parent-id="col-sign-type" data-parent-value="*"<?php echo ( empty($postdata['col-sign-type'] ) ? ' style="display:none;"' : '' ); ?>>
		...
		<td><p><label><span class="gwa-checkbox<?php echo isset($postdata['col-sign-link']['target'] ) ? ' gwa-checked' : ''; ?>" tabindex="0"><span></span><input type="checkbox" name="col-sign-link[target]" tabindex="-1" value="1" <?php echo isset($postdata['col-sign-link']['target'] ) ? ' checked="checked"' : ''; ?>></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>
	...
	<tr data-parent-id="col-sign-type" data-parent-value="*"<?php echo ( empty($postdata['col-sign-type'] ) ? ' style="display:none;"' : '' ); ?>>
		...
		<td><p><label><span class="gwa-checkbox<?php echo isset($postdata['col-sign-link']['nofollow'] ) ? ' gwa-checked' : ''; ?>" tabindex="0"><span></span><input type="checkbox" name="col-sign-link[nofollow]" tabindex="-1" value="1" <?php echo isset($postdata['col-sign-link']['nofollow'] ) ? ' checked="checked"' : ''; ?>></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>                                                                                
