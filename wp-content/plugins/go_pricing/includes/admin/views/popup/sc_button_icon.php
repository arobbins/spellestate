								...
								<tr>
									...
									<td>
										<select name="shortcode">                                
											<option value="fa"><?php _e( 'Font Awesome 4.3 (593)', 'go_pricing_textdomain' ); ?></option>
								...
								<tr style="display:none;">
									...
									<td>					
										<div class="gwa-img-upload">
											...
											<div class="gwa-input-btn"><input type="text" name="image-custom-icon" data-attr="style" data-value="background-image:url({value});"><a href="#" title="<?php esc_attr_e( 'Add', 'go_pricing_textdomain' ); ?>" data-action="img-upload"><i class="fa fa-plus-circle"></i></a></div>
										</div>	
									</td>
