						...
						<div class="gwa-abox-content">
							...
							<table class="gwa-table" data-id="sc-fields" data-shortcode="[go_pricing_youtube{atts}]" data-parent-id="shortcode" data-parent-value="youtube">
								...
								<tr>
									...
									<td><p><label><span class="gwa-checkbox" tabindex="0"><span></span><input type="checkbox" name="yt-autoplay" data-attr="autoplay" tabindex="-1" value="yes"></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>
							...
							<table class="gwa-table" data-id="sc-fields" data-shortcode="[go_pricing_vimeo{atts}]" data-parent-id="shortcode" data-parent-value="vimeo">
								...
								<tr>
									<th><label><?php _e( 'Autoplay?', 'go_pricing_textdomain' ); ?></label></th>
									<td><p><label><span class="gwa-checkbox" tabindex="0"><span></span><input type="checkbox" name="vimeo-autoplay" data-attr="autoplay" tabindex="-1" value="yes"></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>
									<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Whether to play the video automatically (optional).', 'go_pricing_textdomain' ); ?></p></td>									
								</tr>								
							</table>
							...
							<table class="gwa-table" data-id="sc-fields" data-shortcode="[go_pricing_dailymotion{atts}]" data-parent-id="shortcode" data-parent-value="dailymotion">
								...
								<tr>
									<th><label><?php _e( 'Autoplay?', 'go_pricing_textdomain' ); ?></label></th>
									<td><p><label><span class="gwa-checkbox" tabindex="0"><span></span><input type="checkbox" name="dailymotion-autoplay" data-attr="autoplay" tabindex="-1" value="yes"></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>
									<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Whether to play the video automatically (optional).', 'go_pricing_textdomain' ); ?></p></td>									
								</tr>								
							</table>
							<!-- /Dailymotion -->
							...
							<table class="gwa-table" data-id="sc-fields" data-shortcode="[go_pricing_metacafe{atts}]" data-parent-id="shortcode" data-parent-value="metacafe">
								...
								<tr>
									<th><label><?php _e( 'Autoplay?', 'go_pricing_textdomain' ); ?></label></th>
									<td><p><label><span class="gwa-checkbox" tabindex="0"><span></span><input type="checkbox" name="metacafe-autoplay" data-attr="autoplay" tabindex="-1" value="yes"></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>
									<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Whether to play the video automatically (optional).', 'go_pricing_textdomain' ); ?></p></td>									
								</tr>								
							</table>
							<!-- /Metacafe -->
							...
							<table class="gwa-table" data-id="sc-fields" data-shortcode="[go_pricing_html5_video{atts}]" data-parent-id="shortcode" data-parent-value="html5_video">
								<tr>
									...
									<td><div class="gwa-input-btn"><input type="text" name="html5-video-mp4" data-attr="mp4_src" value=""><a href="#" title="<?php esc_attr_e( 'Add', 'go_pricing_textdomain' ); ?>" data-action="file-upload" data-file-type="video"><i class="fa fa-plus-circle"></i></a></div></td>
								...
								<tr>
									...
									<td><div class="gwa-input-btn"><input type="text" name="html5-video-webm" data-attr="webm_src" value=""><a href="#" title="<?php esc_attr_e( 'Add', 'go_pricing_textdomain' ); ?>" data-action="file-upload" data-file-type="video"><i class="fa fa-plus-circle"></i></a></div></td>
								...
								<tr>
									...
									<td><div class="gwa-input-btn"><input type="text" name="html5-video-ogg" data-attr="ogg_src" value=""><a href="#" title="<?php esc_attr_e( 'Add', 'go_pricing_textdomain' ); ?>" data-action="file-upload" data-file-type="video"><i class="fa fa-plus-circle"></i></a></div></td>
								...
								<tr>
									...
									<td>					
										<div class="gwa-img-upload">
											...
											<div class="gwa-input-btn"><input type="text" name="html5-video-poster" data-attr="poster_src" value=""><a href="#" title="<?php esc_attr_e( 'Add', 'go_pricing_textdomain' ); ?>" data-action="img-upload"><i class="fa fa-plus-circle"></i></a></div>
										</div>	
									</td>
								...
								<tr>
									<th><label><?php _e( 'Autoplay?', 'go_pricing_textdomain' ); ?></label></th>
									<td><p><label><span class="gwa-checkbox" tabindex="0"><span></span><input type="checkbox" name="html5-video-autoplay" data-attr="autoplay" tabindex="-1" value="yes"></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>
									<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Whether to play the video automatically (optional).', 'go_pricing_textdomain' ); ?></p></td>									
								</tr>
								<tr>
									<th><label><?php _e( 'Loop?', 'go_pricing_textdomain' ); ?></label></th>
									<td><p><label><span class="gwa-checkbox" tabindex="0"><span></span><input type="checkbox" name="html5-video-loop" data-attr="loop" tabindex="-1" value="yes"></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>
							...
							<table class="gwa-table" data-id="sc-fields" data-shortcode="[go_pricing_soundcloud{atts}]" data-parent-id="shortcode" data-parent-value="soundcloud">
								...
								<tr>
									<th><label><?php _e( 'Autoplay?', 'go_pricing_textdomain' ); ?></label></th>
									<td><p><label><span class="gwa-checkbox" tabindex="0"><span></span><input type="checkbox" name="soundcloud-autoplay" data-attr="autoplay" tabindex="-1" value="yes"></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>
							...
							<table class="gwa-table" data-id="sc-fields" data-shortcode="[go_pricing_beatport{atts}]" data-parent-id="shortcode" data-parent-value="beatport">
								...
								<tr>
									<th><label><?php _e( 'Autoplay?', 'go_pricing_textdomain' ); ?></label></th>
									<td><p><label><span class="gwa-checkbox" tabindex="0"><span></span><input type="checkbox" name="beatport-autoplay" data-attr="autoplay" tabindex="-1" value="yes"></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>
									<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Whether to play the audio track automatically (optional).', 'go_pricing_textdomain' ); ?></p></td>									
								</tr>								
							</table>
							<!-- /Beatport Audio -->
							...
							<table class="gwa-table" data-id="sc-fields" data-shortcode="[go_pricing_map{atts}]" data-parent-id="shortcode" data-parent-value="map">
								...
								<tr style="display:none;">
									...
									<td>					
										<div class="gwa-img-upload">
											...
											<div class="gwa-input-btn"><input type="text" name="map-custom-marker" data-attr="map-icon"><a href="#" title="<?php esc_attr_e( 'Add', 'go_pricing_textdomain' ); ?>" data-action="img-upload"><i class="fa fa-plus-circle"></i></a></div>
										</div>	
									</td>
								...
								<tr class="gwa-row-separator"></tr>
								<tr>
									<th><label><?php _e( 'Market Title', 'go_pricing_textdomain' ); ?></label></th>
								...
								<tr>
									...
									<td><p><label><span class="gwa-checkbox" tabindex="0"><span></span><input type="checkbox" name="map-iw-show" data-attr="popup" tabindex="-1" value="yes"></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>
							...
							<table class="gwa-table" data-id="sc-fields" data-shortcode="[go_pricing_audio{atts}]" data-parent-id="shortcode" data-parent-value="audio">
								<tr>
									...
									<td><div class="gwa-input-btn"><input type="text" name="html5-audio-mp4" data-attr="mp3_src" value=""><a href="#" title="<?php esc_attr_e( 'Add', 'go_pricing_textdomain' ); ?>" data-action="file-upload" data-file-type="audio"><i class="fa fa-plus-circle"></i></a></div></td>
									<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'MP3 source.', 'go_pricing_textdomain' ); ?></p></td>									
								</tr>
								<tr>
									<th><label><?php _e( 'OGG Source', 'go_pricing_textdomain' ); ?></label></th>
									<td><div class="gwa-input-btn"><input type="text" name="html5-audio-ogg" data-attr="ogg_src" value=""><a href="#" title="<?php esc_attr_e( 'Add', 'go_pricing_textdomain' ); ?>" data-action="file-upload" data-file-type="audio"><i class="fa fa-plus-circle"></i></a></div></td>
								...
								<tr>
									...
									<td><div class="gwa-input-btn"><input type="text" name="html5-audio-webm" data-attr="wav_src" value=""><a href="#" title="<?php esc_attr_e( 'Add', 'go_pricing_textdomain' ); ?>" data-action="file-upload" data-file-type="audio"><i class="fa fa-plus-circle"></i></a></div></td>
								...
								<tr>
									<th><label><?php _e( 'Autoplay?', 'go_pricing_textdomain' ); ?></label></th>
									<td><p><label><span class="gwa-checkbox" tabindex="0"><span></span><input type="checkbox" name="html5-audio-autoplay" data-attr="autoplay" tabindex="-1" value="yes"></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>
									<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Whether to play the audio track automatically (optional).', 'go_pricing_textdomain' ); ?></p></td>									
								</tr>
								<tr>
									<th><label><?php _e( 'Loop?', 'go_pricing_textdomain' ); ?></label></th>
									<td><p><label><span class="gwa-checkbox" tabindex="0"><span></span><input type="checkbox" name="html5-audio-loop" data-attr="loop" tabindex="-1" value="yes"></span><?php _e( 'Yes', 'go_pricing_textdomain' ); ?></label></p></td>
