...
<div class="gwa-col-box-add">
	<div class="gwa-col-box-content">							
		<a href="#" data-action="add-footer-row" title="<?php esc_attr_e( 'Add Row', 'go_pricing_textdomain' ); ?>" class="gwa-btn-style1"><i class="fa fa-plus-circle"></i><?php _e( 'Add Row', 'go_pricing_textdomain' ); ?></a>
	</div>									
</div>