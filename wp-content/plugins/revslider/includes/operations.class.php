...
class RevSliderOperations extends RevSliderElementsBase{
	...
	public function getArrTransition(){
		...
		$arrTransition = array(
			...
			"notselectable22"=>"SLOTS AND BOXES",
	...
	public static function getCaptionsCssContentArray(){
		...
		else if(file_exists(RevSliderGlobals::$filepath_captions_original))
			$contentCSS = file_get_contents(RevSliderGlobals::$filepath_captions_original);
		else if(file_exists(RevSliderGlobals::$filepath_backup.'captions.css'))
			$contentCSS = file_get_contents(RevSliderGlobals::$filepath_backup.'captions.css');
		else if(file_exists(RevSliderGlobals::$filepath_backup.'captions-original.css'))
