...
( function( $ ){
	...
	// MAIN STYLING
	/////////////////////////////////////////////
	wp.customize('sf_customizer[design_style_type]',function( value ) {
	...
	wp.customize('sf_customizer[accent_alt_color]',function( value ) {
		value.bind(function(to) {
	...
	wp.customize('sf_customizer[secondary_accent_color]',function( value ) {
		value.bind(function(to) {
	...
	wp.customize('sf_customizer[secondary_accent_alt_color]',function( value ) {
		value.bind(function(to) {
	...
	wp.customize('sf_customizer[inner_page_bg_transparent]',function( value ) {
		value.bind(function(to) {
			if (to === "transparent") {
	...
	wp.customize('sf_customizer[inner_page_bg_color]',function( value ) {
		value.bind(function(to) {
			$('#main-container, .tm-toggle-button-wrap a, ul.bar-styling li > a, ul.bar-styling li > span, ul.bar-styling li > div, ul.bar-styling li > form input, .widget.widget_lip_most_loved_widget li, .spb_portfolio_carousel_widget .portfolio-item, .standard-post-content, .spb_tabs .ui-tabs .ui-tabs-panel, .ui-tabs .ui-tabs-nav li.ui-tabs-active a').css('background-color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[section_divide_color]',function( value ) {
		value.bind(function(to) {
			$('.owl-pagination .owl-page span, .loved-item .loved-count > i, .standard-post-date').css('background-color', to ? to : '' );
	...
	wp.customize('sf_customizer[alt_bg_color]',function( value ) {
		value.bind(function(to) {
			$('.modal-header, .testimonials.carousel-items li .testimonial-text, .widget .wp-tag-cloud li a, .masonry-items .portfolio-item-details, .search-item-img .img-holder, .masonry-items .blog-item .masonry-item-wrap, .bold-design .spb_accordion .spb_accordion_section > h3.ui-state-default, .bold-design .nav-tabs > li a').css('background-color', to ? to : '' );
		});
	});
	...
	// BREADCRUMB STYLING
	/////////////////////////////////////////////
	wp.customize('sf_customizer[breadcrumb_bg_color]',function( value ) {
		value.bind(function(to) {
	...
	wp.customize('sf_customizer[header_bg_color]',function( value ) {
		value.bind(function(to) {
			$('.header-wrap #header, .header-standard-overlay #header, .vertical-header .header-wrap #header-section, #header-section .is-sticky #header.sticky-header').css('background-color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[header_bg_transparent]',function( value ) {
		value.bind(function(to) {
			if (to === "transparent") {
				$('.header-wrap, .vertical-header .header-wrap #header-section').css('background-color', to ? 'transparent' : '' );
			}
		});
	});
	wp.customize('sf_customizer[header_border_color]',function( value ) {
		value.bind(function(to) {
			$('.header-wrap, #header-section .is-sticky .sticky-header, #header-section.header-5 #header, .vertical-header .header-wrap, .header-left .aux-item, .header-right .aux-item').css('border-color', to ? to : '' );
		});
	});
	...
	wp.customize('sf_customizer[header_link_color]',function( value ) {
		value.bind(function(to) {
			$('a.menu-bars-link span, a.menu-bars-link span:before, a.menu-bars-link span:after').css('background-color', to ? to : '' );
		});
	});
	...
	wp.customize('sf_customizer[nav_bg_color]',function( value ) {
		value.bind(function(to) {
			$('#main-nav').css('background-color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[nav_text_color]',function( value ) {
		value.bind(function(to) {
			$('.ajax-search-wrap input[type="text"], .search-result-pt h6, .no-search-results h6, .search-result h5 a, nav .menu > li.menu-item > a').css('color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[nav_selected_bg_color]',function( value ) {
		value.bind(function(to) {
			$('nav .menu li.current-menu-ancestor > a, nav .menu li.current-menu-item > a, nav .menu li.current-scroll-item > a, #mobile-menu .menu ul li.current-menu-item > a').css('background-color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[nav_selected_text_color]',function( value ) {
		value.bind(function(to) {
			$('nav .menu li.current-menu-ancestor > a, nav .menu li.current-menu-item > a, nav .menu li.current-scroll-item > a, #mobile-menu .menu ul li.current-menu-item > a').css('color', to ? to : '' );
		});
	});
	...
	wp.customize('sf_customizer[nav_sm_text_color]',function( value ) {
		value.bind(function(to) {
			$('nav .menu ul.sub-menu li.menu-item > a, nav .menu ul.sub-menu li > span').css('color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[nav_sm_selected_text_color]',function( value ) {
		value.bind(function(to) {
			$('.header-languages .current-language, nav .menu ul li.current-menu-ancestor > a, nav .menu ul li.current-menu-item > a').css('color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[nav_divider]',function( value ) {
		value.bind(function(to) {
			$('nav .menu ul.sub-menu li, nav.mega-menu li .mega .sub .sub-menu, nav.mega-menu li .mega .sub .sub-menu li, nav.mega-menu li .sub-container.non-mega li, nav.mega-menu li .sub li.mega-hdr').css('border-top-style', to ? to : '' );
			$('nav.mega-menu li .sub li.mega-hdr').css('border-right-style', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[nav_divider_color]',function( value ) {
		value.bind(function(to) {
			$('#main-nav, #main-nav ul.menu > li, #main-nav ul.menu > li:first-child, #main-nav ul.menu > li:first-child .full-center nav#main-navigation ul.menu > li, .full-center nav.float-alt-menu ul.menu > li, .bag-header, .bag-product, .bag-empty, .wishlist-empty').css('border-color', to ? to : '' );
			$('nav .menu ul.sub-menu li, nav.mega-menu li .mega .sub .sub-menu, nav.mega-menu li .mega .sub .sub-menu li, nav.mega-menu li .sub-container.non-mega li, nav.mega-menu li .sub li.mega-hdr').css('border-top-color', to ? to : '' );
	...
	wp.customize('sf_customizer[overlay_menu_link_color]',function( value ) {
		value.bind(function(to) {
			$('#overlay-menu nav ul li a, .overlay-menu-open a.overlay-menu-link, .overlay-menu-open #logo h1, .overlay-menu-open .header-left, .overlay-menu-open .header-right, .overlay-menu-open .header-left a, .overlay-menu-open .header-right a, a.overlay-menu-link span').css('color', to ? to : '' );
		});
	});
	...
	wp.customize('sf_customizer[mobile_menu_divider_color]',function( value ) {
		value.bind(function(to) {
			$('.mobile-search-form input[type="text"], #mobile-cart-wrap .shopping-bag-item > a.cart-contents, #mobile-cart-wrap .bag-product, ').css('border-bottom-color', to ? to : '' );
	...
	// POST STYLING
	/////////////////////////////////////////////
	wp.customize('sf_customizer[article_review_bar_alt_color]',function( value ) {
		value.bind(function(to) {
			$('.review-bar').css('background-color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[article_review_bar_color]',function( value ) {
		value.bind(function(to) {
			$('.review-bar .bar, .review-overview-wrap .overview-circle').css('background-color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[article_review_bar_text_color]',function( value ) {
		value.bind(function(to) {
			$('.review-bar .bar, .review-overview-wrap .overview-circle').css('color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[article_extras_bg_color]',function( value ) {
		value.bind(function(to) {
			$('.article-extras').css('background-color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[article_np_bg_color]',function( value ) {
		value.bind(function(to) {
			$('.post-pagination-wrap').css('background-color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[article_np_text_color]',function( value ) {
		value.bind(function(to) {
			$('.post-pagination-wrap .next-article > *, .post-pagination-wrap .next-article a, .post-pagination-wrap .prev-article > *, .post-pagination-wrap .prev-article a').css('color', to ? to : '' );
		});
	});
	...
	wp.customize('sf_customizer[input_bg_color]',function( value ) {
		value.bind(function(to) {
			$('input[type="text"], input[type="email"], input[type="password"], textarea, select, .wpcf7 input[type="text"], .wpcf7 input[type="email"], .wpcf7 textarea, .wpcf7 select, .ginput_container input[type="text"], .ginput_container input[type="email"], .ginput_container textarea, .ginput_container select, .mymail-form input[type="text"], .mymail-form input[type="email"], .mymail-form textarea, .mymail-form select, input[type="date"], input[type="tel"], input.input-text, input[type="number"]').css('background-color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[input_text_color]',function( value ) {
		value.bind(function(to) {
			$('input[type="text"], input[type="email"], input[type="password"], textarea, select, .wpcf7 input[type="text"], .wpcf7 input[type="email"], .wpcf7 textarea, .wpcf7 select, .ginput_container input[type="text"], .ginput_container input[type="email"], .ginput_container textarea, .ginput_container select, .mymail-form input[type="text"], .mymail-form input[type="email"], .mymail-form textarea, .mymail-form select, input[type="date"], input[type="tel"], input.input-text, input[type="number"]').css('color', to ? to : '' );
		});
	});
	...
	// SHORTCODES STYLING
	/////////////////////////////////////////////
	wp.customize('sf_customizer[icon_container_bg_color]',function( value ) {
		value.bind(function(to) {
			$('.sf-icon-cont, .sf-hover .sf-icon-cont, .sf-hover .sf-icon-box-hr').css('background-color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[sf_icon_color]',function( value ) {
		value.bind(function(to) {
			$('.sf-icon').css('color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[sf_icon_alt_color]',function( value ) {
		value.bind(function(to) {
			$('.sf-hover .sf-icon-cont .sf-icon, .sf-hover .sf-icon-cont .sf-icon, .sf-icon-box.sf-icon-box-boxed-one .sf-icon, .sf-icon-box.sf-icon-box-boxed-three .sf-icon').css('color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[boxed_content_color]',function( value ) {
		value.bind(function(to) {
			$('.spb_box_text.coloured .box-content-wrap').css('color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[share_button_bg]',function( value ) {
		value.bind(function(to) {
			$('.article-share label').css('background-color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[share_button_text]',function( value ) {
		value.bind(function(to) {
			$('.article-share label').css('color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[bold_rp_bg]',function( value ) {
		value.bind(function(to) {
			$('.posts-type-bold .recent-post .details-wrap, .masonry-items .blog-item .details-wrap, .blog-grid-items .blog-item > div').css('background-color', to ? to : '' );
		});
	});
	wp.customize('sf_customizer[bold_rp_text]',function( value ) {
		value.bind(function(to) {
			$('.posts-type-bold .recent-post .details-wrap, .masonry-items .blog-item .details-wrap, .blog-grid-items .blog-item > div').css('color', to ? to : '' );
		});
	});
