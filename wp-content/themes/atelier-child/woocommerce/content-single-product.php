...
<div itemscope itemtype="<?php echo woocommerce_get_product_schema(); ?>" id="product-<?php the_ID(); ?>" <?php post_class($extra_class); ?>>
	...
	<?php
        ...
        // Description
        include($_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/atelier-child/includes/product-description.php');

        // Tech Sheets
        include($_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/atelier-child/includes/product-reviews.php');

        // Reviews
        include($_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/atelier-child/includes/product-techsheet.php');
